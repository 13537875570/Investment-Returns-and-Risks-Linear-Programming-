...
public class P3LPTestS1S2 {
	...
	//-----------------------------------------------------------------------------------------------
		double M=1;//amount of Capital
		double a=2;//Risk up limit: a
		...
		double[]r={0.28,0.21};//Returns Ri
		double[]q1={2.5,0};//Risk Rate Q1
		double[]q2={0,1.5};//Risk Rate Q2
		double[]p={0.01,0.02};//Transaction Fee Pi	
	//-----------------------------------------------------------------------------------------------
